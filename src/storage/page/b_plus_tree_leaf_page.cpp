...
auto B_PLUS_TREE_LEAF_PAGE_TYPE::KeyAt(int index) const -> KeyType {
  ...
  //   throw Exception(ExceptionType::OUT_OF_RANGE, "Index out of range in BPlusTreeLeafPage::KeyAt");
  // }
...
void BPlusTreeLeafPage<KeyType, ValueType, KeyComparator>::SetKeyAt(int index, const KeyType &key) {
  ...
  //   throw std::out_of_range("Index out of range in BPlusTreeLeafPage::SetKeyAt");
  // }
...
auto B_PLUS_TREE_LEAF_PAGE_TYPE::ValueAt(int index) const -> ValueType {
  // if (index < 0 || index >= GetSize()) {
  //   throw Exception(ExceptionType::OUT_OF_RANGE, "Index out of range in BPlusTreeLeafPage::ValueAt");
  // }
...
void B_PLUS_TREE_LEAF_PAGE_TYPE::SetValueAt(int index, const ValueType &value) {
  // int siz_ = GetSize();
  // if (index < 0 || index >= siz_) {
  //   throw Exception(ExceptionType::OUT_OF_RANGE, "Index out of range in BPlusTreeLeafPage::SetValueAt");
  // }
